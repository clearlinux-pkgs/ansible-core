...
Source0  : https://github.com/ansible/ansible/archive/v2.15.5/ansible-2.15.5.tar.gz
...
%prep
%setup -q -n ansible-2.15.5
cd %{_builddir}/ansible-2.15.5
pushd ..
cp -a ansible-2.15.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1696892382
