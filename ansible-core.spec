...
Version  : 2.13.4
Release  : 29
URL      : https://github.com/ansible/ansible/archive/v2.13.4/ansible-2.13.4.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.13.4/ansible-2.13.4.tar.gz
...
%prep
%setup -q -n ansible-2.13.4
cd %{_builddir}/ansible-2.13.4
pushd ..
cp -a ansible-2.13.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663017174
