...
Version  : 2.18.3
Release  : 64
URL      : https://github.com/ansible/ansible/archive/v2.18.3/ansible-2.18.3.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.18.3/ansible-2.18.3.tar.gz
...
%prep
%setup -q -n ansible-2.18.3
cd %{_builddir}/ansible-2.18.3
pushd ..
cp -a ansible-2.18.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740438464
