...
Source0  : https://github.com/ansible/ansible/archive/v2.14.1/ansible-2.14.1.tar.gz
...
%prep
%setup -q -n ansible-2.14.1
cd %{_builddir}/ansible-2.14.1
pushd ..
cp -a ansible-2.14.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670487913
