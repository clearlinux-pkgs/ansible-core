...
Version  : 2.13.1
Release  : 22
URL      : https://github.com/ansible/ansible/archive/v2.13.1/ansible-2.13.1.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.13.1/ansible-2.13.1.tar.gz
...
%prep
%setup -q -n ansible-2.13.1
cd %{_builddir}/ansible-2.13.1
pushd ..
cp -a ansible-2.13.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656369105
...
cp %{_builddir}/ansible-2.13.1/COPYING %{buildroot}/usr/share/package-licenses/ansible-core/338650eb7a42dd9bc1f1c6961420f2633b24932d
cp %{_builddir}/ansible-2.13.1/licenses/Apache-License.txt %{buildroot}/usr/share/package-licenses/ansible-core/c700a8b9312d24bdc57570f7d6a131cf63d89016
cp %{_builddir}/ansible-2.13.1/licenses/MIT-license.txt %{buildroot}/usr/share/package-licenses/ansible-core/df180fcf964224ba9180a646ca107bfe65595f23
cp %{_builddir}/ansible-2.13.1/licenses/PSF-license.txt %{buildroot}/usr/share/package-licenses/ansible-core/e9665a5e46702a4080c47049e29edf05eb70bfd6
