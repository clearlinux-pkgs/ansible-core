...
Source0  : https://github.com/ansible/ansible/archive/v2.12.3/ansible-2.12.3.tar.gz
...
%prep
%setup -q -n ansible-2.12.3
cd %{_builddir}/ansible-2.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647629223
...
cp %{_builddir}/ansible-2.12.3/COPYING %{buildroot}/usr/share/package-licenses/ansible-core/338650eb7a42dd9bc1f1c6961420f2633b24932d
cp %{_builddir}/ansible-2.12.3/licenses/Apache-License.txt %{buildroot}/usr/share/package-licenses/ansible-core/c700a8b9312d24bdc57570f7d6a131cf63d89016
cp %{_builddir}/ansible-2.12.3/licenses/MIT-license.txt %{buildroot}/usr/share/package-licenses/ansible-core/df180fcf964224ba9180a646ca107bfe65595f23
cp %{_builddir}/ansible-2.12.3/licenses/PSF-license.txt %{buildroot}/usr/share/package-licenses/ansible-core/7b14725671bae6dc04be2b87de58131f0614dfad
cp %{_builddir}/ansible-2.12.3/packaging/debian/copyright %{buildroot}/usr/share/package-licenses/ansible-core/b7f3dc6d692392795202ab560c7583e986d8352b
