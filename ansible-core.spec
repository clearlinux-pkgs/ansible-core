...
Version  : 2.16.3
Release  : 49
URL      : https://github.com/ansible/ansible/archive/v2.16.3/ansible-2.16.3.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.16.3/ansible-2.16.3.tar.gz
...
%prep
%setup -q -n ansible-2.16.3
cd %{_builddir}/ansible-2.16.3
pushd ..
cp -a ansible-2.16.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706628260
