...
Source0  : https://github.com/ansible/ansible/archive/v2.14.0/ansible-2.14.0.tar.gz
...
%prep
%setup -q -n ansible-2.14.0
cd %{_builddir}/ansible-2.14.0
pushd ..
cp -a ansible-2.14.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667852769
