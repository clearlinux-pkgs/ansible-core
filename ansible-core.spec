...
Version  : 2.14.3
Release  : 35
URL      : https://github.com/ansible/ansible/archive/v2.14.3/ansible-2.14.3.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.14.3/ansible-2.14.3.tar.gz
...
%prep
%setup -q -n ansible-2.14.3
cd %{_builddir}/ansible-2.14.3
pushd ..
cp -a ansible-2.14.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677597152
