...
Version  : 2.16.0
Release  : 45
URL      : https://github.com/ansible/ansible/archive/v2.16.0/ansible-2.16.0.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.16.0/ansible-2.16.0.tar.gz
...
%prep
%setup -q -n ansible-2.16.0
cd %{_builddir}/ansible-2.16.0
pushd ..
cp -a ansible-2.16.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699371544
