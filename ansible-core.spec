...
Version  : 2.13.2
Release  : 24
URL      : https://github.com/ansible/ansible/archive/v2.13.2/ansible-2.13.2.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.13.2/ansible-2.13.2.tar.gz
...
%prep
%setup -q -n ansible-2.13.2
cd %{_builddir}/ansible-2.13.2
pushd ..
cp -a ansible-2.13.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1658181549
...
cp %{_builddir}/ansible-2.13.2/COPYING %{buildroot}/usr/share/package-licenses/ansible-core/338650eb7a42dd9bc1f1c6961420f2633b24932d
cp %{_builddir}/ansible-2.13.2/licenses/Apache-License.txt %{buildroot}/usr/share/package-licenses/ansible-core/c700a8b9312d24bdc57570f7d6a131cf63d89016
cp %{_builddir}/ansible-2.13.2/licenses/MIT-license.txt %{buildroot}/usr/share/package-licenses/ansible-core/df180fcf964224ba9180a646ca107bfe65595f23
cp %{_builddir}/ansible-2.13.2/licenses/PSF-license.txt %{buildroot}/usr/share/package-licenses/ansible-core/e9665a5e46702a4080c47049e29edf05eb70bfd6
