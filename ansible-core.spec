...
Version  : 2.16.6
Release  : 52
URL      : https://github.com/ansible/ansible/archive/v2.16.6/ansible-2.16.6.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.16.6/ansible-2.16.6.tar.gz
...
%prep
%setup -q -n ansible-2.16.6
cd %{_builddir}/ansible-2.16.6
pushd ..
cp -a ansible-2.16.6 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713275956
