...
Version  : 2.14.2
Release  : 34
URL      : https://github.com/ansible/ansible/archive/v2.14.2/ansible-2.14.2.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.14.2/ansible-2.14.2.tar.gz
...
%prep
%setup -q -n ansible-2.14.2
cd %{_builddir}/ansible-2.14.2
pushd ..
cp -a ansible-2.14.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675113459
