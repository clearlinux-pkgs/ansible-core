...
Version  : 2.18.2
Release  : 63
URL      : https://github.com/ansible/ansible/archive/v2.18.2/ansible-2.18.2.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.18.2/ansible-2.18.2.tar.gz
...
%prep
%setup -q -n ansible-2.18.2
cd %{_builddir}/ansible-2.18.2
pushd ..
cp -a ansible-2.18.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738014655
