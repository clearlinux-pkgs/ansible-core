...
Version  : 2.18.5
Release  : 66
URL      : https://github.com/ansible/ansible/archive/v2.18.5/ansible-2.18.5.tar.gz
Source0  : https://github.com/ansible/ansible/archive/v2.18.5/ansible-2.18.5.tar.gz
...
%prep
%setup -q -n ansible-2.18.5
cd %{_builddir}/ansible-2.18.5
pushd ..
cp -a ansible-2.18.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745332038
